...
function Food() {
    ...
    this.show = function () {
        ...
        this._food.style.backgroundSize = '104%';
        ...
        for (var i = 0; i < this.body.length; i++) {
            ...
            if (i == 0) {
                ...
                if (pseg[0] < segx && nseg[1] > segy || nseg[0] < segx && pseg[1] > segy) {
                    ...
                    this.body[i][3].style.backgroundPosition = '-0.5px 1.5px'
                    this.body[i][3].style.borderRadius = '0 20px 0 3px'
                } else if (pseg[1] < segy && nseg[0] < segx || nseg[1] < segy && pseg[0] < segx) {
                    // Angle Up-Left
                    this.body[i][3].style.backgroundSize = '100%'
                    this.body[i][3].style.backgroundPosition = '-0.5px -0.5px'
                    this.body[i][3].style.borderRadius = '3px 0 20px 0'
                } else if (pseg[0] > segx && nseg[1] < segy || nseg[0] > segx && pseg[1] < segy) {
                    // Angle Right-Up
                    this.body[i][3].style.backgroundSize = '100%'
                    this.body[i][3].style.backgroundPosition = '1.5px -0.5px'
                    this.body[i][3].style.borderRadius = '0 3px 0 20px'
                } else if (pseg[1] > segy && nseg[0] > segx || nseg[1] > segy && pseg[0] > segx) {
                    // Angle Down-Right
                    this.body[i][3].style.backgroundSize = '100%'
                    this.body[i][3].style.backgroundPosition = '1.5px 1.5px'
                    this.body[i][3].style.borderRadius = '20px 0 3px 0'
